...
export const INIT_COMPANIES = [
  {
    ...
    address: '456, Green Valley Lane',
    description: 'Financial Consultancy',
  },
  {
    name: 'Sunshine Enterprises',
    address: '789, Ocean Breeze Avenue',
  ...
  },
  {
    ...
    address: '654, Tech Park Boulevard',
    description: 'Software Development',
  },
  {
    name: 'Bright Horizons Corp',
    address: '987, Meadow Ridge',
    description: 'HR Solutions',
  },
  {
    name: 'Prime Marketing Group',
    address: '159, Central Plaza',
    description: 'Digital Marketing',
  },
  {
    name: 'Apex Builders',
    address: '753, Redwood Circle',
    description: 'Construction Services',
  },
  {
    name: 'EcoTech Solutions',
    address: '951, Riverbank Road',
    description: 'Renewable Energy',
  },
  {
    name: 'Urban Dynamics Ltd',
    address: '369, Horizon Boulevard',
    description: 'Urban Planning',
  },
  {
    name: 'NextGen Advertising',
    address: '852, Creative District',
    description: 'Advertising and PR',
  },
  {
    name: 'Blue Sky Retailers',
    address: '741, Shopping Square',
    description: 'Retail Distribution',
  },
  {
    name: 'SecureTech Solutions',
    address: '258, Security Drive',
  ...
  {
    name: 'Global Traders Corp',
    address: '369, Commerce Street',
    description: 'International Trade',
  },
  {
    name: 'Green Earth Partners',
    address: '147, EcoPark Avenue',
    description: 'Environmental Consulting',
  },
  {
    name: 'Metro Designs',
    address: '951, Fashion District',
